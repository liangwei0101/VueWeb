var site_settings = '<div class="ts-button">'
    ...
    +'</div>'
    +'<div class="ts-body">'
	    +'<div class="ts-title">主题</div>'
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="static/css/theme-default.css"><img src="../../static/img/themes/default.jpg"/></a>'
            +'<a href="#" data-theme="static/css/theme-brown.css"><img src="../../static/img/themes/brown.jpg"/></a>'
            +'<a href="#" data-theme="static/css/theme-blue.css"><img src="../../static/img/themes/blue.jpg"/></a>'
            +'<a href="#" data-theme="static/css/theme-white.css"><img src="../../static/img/themes/light.jpg"/></a>'
            +'<a href="#" data-theme="static/css/theme-black.css"><img src="../../static/img/themes/black.jpg"/></a>'
        +'</div>'
		+'<div class="ts-title">布局</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="radio" class="iradio" name="st_layout_boxed" value="0" checked/> 全屏宽度</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="radio" class="iradio" name="st_layout_boxed" value="1"/> 固定</label>'
        +'</div>'
        +'<div class="ts-title">选项</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_head_fixed" value="1"/>固定头部</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_fixed" value="1" checked/> 固定侧边栏</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_scroll" value="1"/> Scroll Sidebar</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_right" value="1"/> 右侧边栏</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_custom" value="1"/> 自定义导航</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_toggled" value="1"/> 切换导航</label>'
        +'</div>'
